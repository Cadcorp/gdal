...
class /* Cadcorp */ CPL_DLL /* Cadcorp */ ITABFeaturePen /* non final */
{
  protected:
    int m_nPenDefIndex;
    TABPenDef m_sPenDef;
...
class /* Cadcorp */ CPL_DLL /* Cadcorp */ ITABFeatureFont /* non final */
{
  protected:
    int m_nFontDefIndex;
 ...
 *--------------------------------------------------------------------*/
class /* Cadcorp */ CPL_DLL /* Cadcorp */ TABFeature /* non final*/ : public OGRFeature
{
  protected:
